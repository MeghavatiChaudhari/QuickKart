...
import { fetchAllProductsAsync ,selectAllProducts , fetchProductsByFiltersAsync, selectTotalItems, selectCategories, selectBrands, fetchBrandsAsync, fetchCategoriesAsync} from '../ProductSlice';
// import {
//   increment,
//   selectAllProducts,
//   selectCount,
...
const subCategories = [
  { name: 'Totes', thumbnail: '#' },
  { name: 'Backpacks', thumbnail: '#' },
  { name: 'Travel Bags', thumbnail: '#' },
  { name: 'Hip Bags', thumbnail: '#' },
  { name: 'Laptop Sleeves', thumbnail: '#' },
]
