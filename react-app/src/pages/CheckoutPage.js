...
function checkoutPage() {
   ...
   const onSubmit = (data) => {
    ...
    const handleOrder=(e)=>{
      const order={items,totalAmount,totalItems,user,paymentMethod,selectedAddress}
       ...
       //todo:on sever change stock number of items
    }
  ...
  {!items.length && <Navigate to='/' replace={true}></Navigate>}
    ...
    <form className="bg-white px-5 py-5 mt-12 mb-12" noValidate  
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="sm:col-span-4">
              ...
              <div className="mt-2">
                <input
                  id="email"
                 {...register('email',{required:'email is rewuired'})}
                  type="email"
                  className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                />
              </div>
            ...
            <div className="sm:col-span-3">
              ...
              <input
                  id="phone"
                 {...register('phone',{required:'phone is rewuired'})}
                  type="tel"
                  className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                />
              </div>
          ...
          <li key={item.id} className="flex py-6">
            ...
            <div className="ml-4 flex flex-1 flex-col">
              ...
              <div className="flex flex-1 items-end justify-between text-sm">
                ...
                <label htmlFor="quantity" class="inline mr-5 text-sm font-medium leading-6 text-gray-900">Qty</label>
  ...
  <div className="flex justify-between my-2 ext-base font-medium text-gray-900">
