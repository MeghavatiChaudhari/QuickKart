    ...
    <form className="bg-white px-5 py-5 mt-12 mb-12">
      <div className="space-y-12">
        ...
        {addresses.map((addresses) => (
          <li key={addresses.email} className="flex justify-between gap-x-6 px-5 py-5 border-solid border-2 border-gray-200">
      ...
      <li key={product.id} className="flex py-6">
        ...
        <div className="ml-4 flex flex-1 flex-col">
          ...
          <div className="flex flex-1 items-end justify-between text-sm">
            ...
            <label for="quantity" class="inline mr-5 text-sm font-medium leading-6 text-gray-900">Qty</label>
